...
abstract class LevelExtractorMixin {
    ...
    private @Nullable BlockEntityRenderState flw$skipVisualizedGlobalBlockEntity(BlockEntityRenderDispatcher dispatcher, BlockEntity blockEntity, float partialTicks, ModelFeatureRenderer.@Nullable CrumblingOverlay breakProgress, boolean isGloballyRendered, @Nullable Frustum frustum, Operation<BlockEntityRenderState> original) {
