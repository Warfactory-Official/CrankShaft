...
public interface EntityVisualizer<T extends Entity> {
    ...
    /**
     * Checks if the given entity should not render with the vanilla entity Render.
     * @param entity The entity to check.
     * @return {@code true} if the entity should not render with the vanilla entity Render, {@code false} if it should.
     */
