...
public final class EntityVisualizerBuilder<T extends Entity> {
    ...
    public EntityVisualizerBuilder(Configurator configurator, Class<T> type) {
    ...
    /**
     * Sets a predicate to determine whether to skip rendering with the vanilla {@link Render}.
     *
    ...
    /**
     * Sets a predicate to never skip rendering with the vanilla {@link Render}.
     *
     * @return {@code this}
     */
