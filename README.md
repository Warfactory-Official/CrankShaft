...
dependencies {
    // NeoForge
    implementation("dev.engine_room:crankshaft-neoforge:1.3.1+mc26.2")
    // Fabric
    implementation("dev.engine_room:crankshaft-fabric:1.3.1+mc26.2")
}
```
...
implementation("dev.engine_room:crankshaft-fabric:1.3.1+mc26.2-SNAPSHOT")
```
