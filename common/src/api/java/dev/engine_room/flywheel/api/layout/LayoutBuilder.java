...
public interface LayoutBuilder {
    ...
    LayoutBuilder matrix(String name, FloatRepr repr, @Range(from = 2, to = 4) int rows,
    ...
    LayoutBuilder vectorArray(String name, ValueRepr repr, @Range(from = 2, to = 4) int size,
                              @Range(from = 1, to = 256) int length);

    LayoutBuilder matrixArray(String name, FloatRepr repr, @Range(from = 2, to = 4) int rows,
                              @Range(from = 2, to = 4) int columns, @Range(from = 1, to = 256) int length);

    LayoutBuilder matrixArray(String name, FloatRepr repr, @Range(from = 2, to = 4) int size,
                              @Range(from = 1, to = 256) int length);
