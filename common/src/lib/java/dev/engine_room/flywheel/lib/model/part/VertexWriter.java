...
// MeshTree bakes model layers concurrently on worker threads, so this deliberately does NOT implement Sodium's
// VertexBufferWriter (its process-wide static scratch races); the per-vertex VertexConsumer path is thread-safe.
class VertexWriter implements VertexConsumer {
    ...
    public VertexConsumer setColor(int color) {
        // ignore color (26.2 promoted this to an abstract VertexConsumer method)
        return this;
    }
    ...
    public VertexConsumer setLineWidth(float width) {
        // ignore line width (26.2 added this to VertexConsumer; irrelevant for baked solid geometry)
        return this;
    }
