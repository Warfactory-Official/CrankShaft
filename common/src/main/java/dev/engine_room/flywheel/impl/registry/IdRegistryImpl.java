...
public class IdRegistryImpl<T> implements IdRegistry<T> {
    ...
    private final Object2ReferenceMap<Identifier, T> map = Object2ReferenceMaps.synchronize(
            new Object2ReferenceOpenHashMap<>());
    private final Reference2ObjectMap<T, Identifier> reverseMap = Reference2ObjectMaps.synchronize(
    ...
    public void register(Identifier id, T object) {
        ...
        if (oldId != null) {
            throw new IllegalArgumentException(
                    "Cannot override ID '" + id + "' with registration for ID '" + oldId + "'!");
        }
    }
