...
public final class Uniforms {
    public static final int FRAME_INDEX = 8;
    public static final int OPTIONS_INDEX = 10;
    public static final int PLAYER_INDEX = 11;
    ...
    private static final UniformBuffer[] ALL_BUFFERS = {FrameUniforms.BUFFER, OptionsUniforms.BUFFER, PlayerUniforms.BUFFER, LevelUniforms.BUFFER};
