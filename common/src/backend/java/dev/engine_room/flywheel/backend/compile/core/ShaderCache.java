...
public class ShaderCache {
    ...
    public static void expand(List<SourceComponent> rootSources, Consumer<SourceComponent> out) {
    ...
    public GlShader compile(GlslVersion glslVersion, ShaderType shaderType, String name, Consumer<Compilation> callback,
    ...
    public GlShader compile(GlslVersion glslVersion, GlslProfile profile, ShaderType shaderType, String name,
                            Consumer<Compilation> callback, List<SourceComponent> sourceComponents) {
