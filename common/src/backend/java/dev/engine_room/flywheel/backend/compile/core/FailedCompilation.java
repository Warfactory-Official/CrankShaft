...
public class FailedCompilation {
    ...
    public FailedCompilation(String shaderName, List<SourceFile> files, String generatedSource, String completeSource,
                             String errorLog) {
    ...
    private ErrorBuilder interpretWithSpan(ErrorLevel errorLevel, int fileId, int lineNo, @Nullable String span,
                                           String msg) {
        var sourceFile = files.get(fileId - 1);
