...
const uint FLW_MAT_TRANSPARENCY_ORDER_INDEPENDENT = 6u;
const uint FLW_MAT_TRANSPARENCY_ORDER_INDEPENDENT_ADDITIVE = 7u;
const uint FLW_MAT_TRANSPARENCY_TRANSLUCENT_ALPHA_REPLACE = 8u;
